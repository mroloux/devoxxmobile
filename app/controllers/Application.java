...
public class Application extends Controller {
    ...
    private static List<Talk> getTalks(String day) throws IOException {
        List<Map<String, String>> talks = new Gson().fromJson(WS.url("https://cfp.devoxx.com/rest/v1/events/7/schedule/day/%s", day).get().getString(), List.class);
        return validTalks(transform(talks, new Function<Map<String, String>, Talk>() {
            @Override
            public Talk apply(Map<String, String> talkAsMap) {
